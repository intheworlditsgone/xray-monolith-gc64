...
void CAI_Stalker::net_Destroy()
{
	...
	I	= std::find(Device.seqParallelLua.begin(),Device.seqParallelLua.end(),f);
	VERIFY							(I == Device.seqParallelLua.end());
#endif // DEBUG
...
void CAI_Stalker::UpdateCL()
{
	START_PROFILE("stalker")
		START_PROFILE("stalker/client_update")
			...
			VERIFY							(I == Device.seqParallelLua.end());
#endif
					Device.seqParallelLua.push_back(
...
void CAI_Stalker::ChangeVisual(shared_str NewVisual)
{
	...
	if (V)
	{
		...
		ResetBoneProtections(NULL, nullptr);
		reattach_items();
